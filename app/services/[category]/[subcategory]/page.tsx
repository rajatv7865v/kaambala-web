    ...
    'ac-installation': [
      {
        ...
        rating: 4.8,
        reviews: '2.8K+',
        image: 'https://images.unsplash.com/photo-1631542771833-cff2a0e0c0a0?w=600&h=400&fit=crop',
  ...
  const baseServices = [
    {
      ...
      rating: 4.7,
      reviews: '1.5K+',
      image: `https://images.unsplash.com/photo-${Math.floor(Math.random() * 1000000)}?w=600&h=400&fit=crop`,
...
function SubcategoryServicesContent() {
  ...
  useEffect(() => {
    ...
    if (serviceData[categoryKey] && serviceData[categoryKey][subcategoryKey]) {
      setServices(serviceData[categoryKey][subcategoryKey])
    } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* Hero Section */}
      <section className={`bg-gradient-to-r ${categoryColor} text-white py-12 px-4`}>
        ...
        <div className="max-w-7xl mx-auto">
          {services.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service) => (
                ...
                >
                  ...
                  <div className="relative h-64 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.className = 'relative h-64 overflow-hidden bg-gradient-to-br from-primary-100 via-primary-50 to-accent-100 flex items-center justify-center'
                    ...
                    {/* Rating Badge */}
                    <div className="absolute top-4 right-4 bg-white rounded-lg px-3 py-2 shadow-lg flex items-center gap-1.5 backdrop-blur-sm bg-white/95">
                  ...
                  {/* Service Details */}
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#e56481] transition-colors">
                      {service.name}
                    </h3>
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="flex-1 px-6 py-3 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
                      ...
                      <button
                        ...
                        className="px-6 py-3 rounded-xl font-semibold border-2 border-[#e56481] text-[#e56481] hover:bg-[#e56481] hover:text-white transition-all duration-300 transform hover:scale-105 active:scale-95"
                      >
                        Book Now
                      </button>
                    </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-6">We couldn't find any services for this subcategory.</p>
              <button
