        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <AnimateOnScroll animation="fade-in-up" delay={400}>
            ...
            <div className="flex gap-3 mb-6">
              <a href="https://www.facebook.com/share/16ZNgJLcrr/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-secondary-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-secondary-500/50">
              ...
              <a href="https://www.instagram.com/kaambala.com_?igsh=MTRlY3U4cGsydmRkdg==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-secondary-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-secondary-500/50">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/@Kaambalahaina" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-secondary-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-secondary-500/50">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
